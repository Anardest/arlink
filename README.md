# 🔗 arlink
Минимальный сервис сокращения ссылок на Node.js + TypeScript с PostgreSQL. Создаёт уникальные коды для длинных URL, поддерживает дубликаты (возвращает существующий код).
## 🛠 Стек технологий
